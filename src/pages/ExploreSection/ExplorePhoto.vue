        ...
        methods:{
            ...
            Filter(){
                ...
                axios.get('http://127.0.0.1:8000/api/artists').then((res)=>{
                    ...
                    this.Photographers=controllati;
                });         
            }
        },
        created(){
...
<template>
    ...
    <div class="all-section">
        <h2 v-if="Photographers.length==0">non ci sono artisti che soddisfano i parametri !!</h2>
            ...
            <RouterLink :to="{ name: 'artist-page', params: { slug: artist.slug } }">
                ...
                <div class="card-data">
                    ...
                    <div class="tecnique" v-for="tecnique in artist.techniques">
                        <small v-if="tecnique.name=='Fotografo'">{{ tecnique.name }}</small>
                    </div>
                </div>
            </RouterLink>
        </div>

    ...
    export default{
        ...
        created(){
            ...
            axios.get('http://127.0.0.1:8000/api/artists').then((res)=>{
                ...
                this.VideoMakers=FilteredArtist;
            });
        }
...
<template>
    ...
    <div class="all-section">
        <h2 v-if="VideoMakers.length==0">non ci sono artisti che soddisfano i parametri !!</h2>
        <div class="single-card" v-for="(artist , index) in VideoMakers">

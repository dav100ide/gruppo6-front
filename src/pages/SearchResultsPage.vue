<template>
   <section>
      <div class="container">
         ...
         <h2
            id="missing-genre-message"
            v-if="
               this.toSearch != 'SCULTORE' &&
               this.toSearch != 'MUSICISTA' &&
               this.toSearch != 'REGISTA' &&
               this.toSearch != 'FOTOGRAFO' &&
               this.toSearch != 'PITTORE' &&
               this.toSearch != 'VIDEOMAKER' &&
               this.toSearch != 'ATTORE' &&
               this.toSearch != '' &&
               this.toSearch != 'SCULTORI' &&
               this.toSearch != 'MUSICISTI' &&
               this.toSearch != 'REGISTI' &&
               this.toSearch != 'FOTOGRAFI' &&
               this.toSearch != 'PITTORI' &&
               this.toSearch != 'VIDEOMAKERS' &&
               this.toSearch != 'ATTORI'
            "
         >
            Non ci sono artisti di questo genere !!
            <a href="/search">cerca qualcos'altro..</a>
         </h2>
